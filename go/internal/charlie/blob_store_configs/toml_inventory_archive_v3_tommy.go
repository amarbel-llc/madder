...
type TomlInventoryArchiveV3Document struct {
	data   TomlInventoryArchiveV3
	cstDoc *document.Document
	model  *cst.Value
}

func DecodeTomlInventoryArchiveV3(input []byte) (*TomlInventoryArchiveV3Document, error) {
	...
	d := &TomlInventoryArchiveV3Document{
		cstDoc: doc,
		model:  model,
	}
...
func (d *TomlInventoryArchiveV3Document) Data() *TomlInventoryArchiveV3 {
	return &d.data
}

func (d *TomlInventoryArchiveV3Document) Encode() ([]byte, error) {
	{
...
func (d *TomlInventoryArchiveV3Document) Undecoded() []string {
	if d.model == nil {
		return nil
	}
...
func (d *TomlInventoryArchiveV3Document) Comment(key string) string {
	return d.cstDoc.GetComment(key)
}

func (d *TomlInventoryArchiveV3Document) SetComment(key, comment string) {
	d.cstDoc.SetComment(key, comment)
}

func (d *TomlInventoryArchiveV3Document) InlineComment(key string) string {
	return d.cstDoc.GetInlineComment(key)
}

func (d *TomlInventoryArchiveV3Document) SetInlineComment(key, comment string) {
	d.cstDoc.SetInlineComment(key, comment)
}

func DecodeTomlInventoryArchiveV3Into(data *TomlInventoryArchiveV3, sub *cst.Value) error {
...
func EncodeTomlInventoryArchiveV3From(data *TomlInventoryArchiveV3, doc *document.Document, container *cst.Node) error {
	{
