...
type TomlMultiV1Document struct {
	data   TomlMultiV1
	cstDoc *document.Document
	model  *cst.Value
}

func DecodeTomlMultiV1(input []byte) (*TomlMultiV1Document, error) {
...
func (d *TomlMultiV1Document) Data() *TomlMultiV1 {
	return &d.data
}

func (d *TomlMultiV1Document) Encode() ([]byte, error) {
	if err := d.data.Validate(); err != nil {
		return nil, fmt.Errorf("validation failed: %w", err)
	}
...
func (d *TomlMultiV1Document) Undecoded() []string {
	if d.model == nil {
		return nil
	}
...
func (d *TomlMultiV1Document) Comment(key string) string {
	return d.cstDoc.GetComment(key)
}

func (d *TomlMultiV1Document) SetComment(key, comment string) {
	d.cstDoc.SetComment(key, comment)
}

func (d *TomlMultiV1Document) InlineComment(key string) string {
	return d.cstDoc.GetInlineComment(key)
}

func (d *TomlMultiV1Document) SetInlineComment(key, comment string) {
	d.cstDoc.SetInlineComment(key, comment)
}

func DecodeTomlMultiV1Into(data *TomlMultiV1, sub *cst.Value) error {
...
func EncodeTomlMultiV1From(data *TomlMultiV1, doc *document.Document, container *cst.Node) error {
	if err := data.Validate(); err != nil {
		return fmt.Errorf("validation failed: %w", err)
	}
