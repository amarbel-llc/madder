...
type TomlS3V1Document struct {
	data   TomlS3V1
	cstDoc *document.Document
	model  *cst.Value
}

func DecodeTomlS3V1(input []byte) (*TomlS3V1Document, error) {
...
func (d *TomlS3V1Document) Data() *TomlS3V1 {
	return &d.data
}

func (d *TomlS3V1Document) Encode() ([]byte, error) {
	if d.data.Endpoint != "" {
...
func (d *TomlS3V1Document) Undecoded() []string {
	if d.model == nil {
		return nil
	}
...
func (d *TomlS3V1Document) Comment(key string) string {
	return d.cstDoc.GetComment(key)
}

func (d *TomlS3V1Document) SetComment(key, comment string) {
	d.cstDoc.SetComment(key, comment)
}

func (d *TomlS3V1Document) InlineComment(key string) string {
	return d.cstDoc.GetInlineComment(key)
}

func (d *TomlS3V1Document) SetInlineComment(key, comment string) {
	d.cstDoc.SetInlineComment(key, comment)
}

func DecodeTomlS3V1Into(data *TomlS3V1, sub *cst.Value) error {
...
func EncodeTomlS3V1From(data *TomlS3V1, doc *document.Document, container *cst.Node) error {
	if data.Endpoint != "" {
