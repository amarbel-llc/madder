...
// at build time. Exposed as a tool over MCP with ReadOnlyHint set so MCP
// clients can query the running madder's identity.
type Version struct{}
...
func (cmd Version) GetDescription() futility.Description {
	return futility.Description{
		Short: "print madder build version and commit",
